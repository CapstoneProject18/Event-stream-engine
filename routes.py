...
def home():
	...
	posts = Post.query.order_by(Post.date_posted.desc()).paginate(page=page, per_page=2) #PAGINATE ALL POSTS. PER PAGE IS 5
...
def user_posts(username):
	...
	posts = Post.query.filter_by(author=user)\
			...
			.paginate(page=page, per_page=2) #PAGINATE ALL POSTS. PER PAGE IS 5
